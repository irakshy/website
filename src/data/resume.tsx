...
export const DATA = {
  ...
  description:
    "Engineer turing into Entrepreneur. I love building things and helping people. Very active on Twitter.",
  summary:
    "At the sept of 2024, I quit my job as a IT engineer to go fulltime into trying & experimenting to build multo dollor businesses. In the past, [I pursued a double degree in computer science and business](/#education), [interned at big tech companies in Silicon Valley](https://www.youtube.com/watch?v=d-LJ2e5qKdE), and [competed in over 21 hackathons for fun](/#hackathons). I also had the pleasure of being a part of the cohort 2 of called (https://www.100xengineers.com/).",
